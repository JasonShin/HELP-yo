...
import {getAllSessionsTypes, searchSessionBookingsByDate, searchSessionBookingsByLocation} from '../../public/js/api/sessions.api';


describe('Retreiving session types', function() {
    this.timeout(20000);

    it('should retrieve all sessions types', async() => {

        const response = await getAllSessionsTypes();
    });
