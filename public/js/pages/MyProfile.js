...
class MyProfile extends React.Component {
    ...
    componentDidMount(){
        FirebaseAPI.context.auth().onAuthStateChanged(firebaseUser => {
            if (firebaseUser) {
                StudentStore.fetchStudent(firebaseUser.email, this.fetchStudentCallback);
            } else {
    ...
    render() {
        ...
        if (this.state.profile) {
            ...
            // console.log(StudentId, fullname, preferredOtherName, status, degree, firstLanguage, countryOrigin);
